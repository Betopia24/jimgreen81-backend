        ...
        <tr>
            <td style="padding: 40px 20px;">
                ...
                <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); overflow: hidden;">
                    ...
                    <!-- Header -->
                    <tr>
                        <td style="background: linear-gradient(135deg, #bf774c 0%, #f3a97b 100%); padding: 40px 30px; text-align: center;">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="color: #666666; margin: 0 0 30px; font-size: 16px; line-height: 1.6;">
                                To complete your email verification, please enter the following 4-digit code in the verification form:
                            </p>
                            ...
                            <div style="background-color: #f0f9ff; border: 1px solid #bae6fd; border-radius: 8px; padding: 20px; margin: 30px 0;">
                                ...
                                <ol style="color: #0369a1; margin: 0; padding-left: 20px; font-size: 14px; line-height: 1.6;">
                                    ...
                                    <li style="margin-bottom: 8px;">Enter the 4-digit code exactly as shown above</li>
                                ...
                                <div style="display: flex; align-items: flex-start;">
                                    ...
                                    <div>
                                        ...
                                        <p style="color: #92400e; margin: 0; font-size: 14px; line-height: 1.5;">
                                            This verification code will expire in <strong>${expireMinute} minutes</strong>. If you need a new code, please request another verification email.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <tr>
                        <td style="background-color: #f8f9fa; padding: 30px; text-align: center; border-top: 1px solid #e9ecef;">
                            <p style="color: #666666; margin: 0 0 15px; font-size: 14px;">
                                ...
                                <a href="mailto:onceuponalife20205@gmail.com" style="color: #4f46e5; text-decoration: none;">onceuponalife20205@gmail.com</a>
                            </p>
                            ...
                            <div style="margin: 20px 0;">
                             ...
                             <a href="https://onceuponlife.com" style="color: #4f46e5; font-size:14px; text-decoration: none;">www.onceuponlife.com</a>
